...
public class StartStateController {
    ...
    public List<StartState> getStartState(){return startStateService.getStartState();}

    @GetMapping("/getStartStateById/{id}")
    public StartState getStartStateById(Long id){return startStateService.getStartStateById(id);}
}
