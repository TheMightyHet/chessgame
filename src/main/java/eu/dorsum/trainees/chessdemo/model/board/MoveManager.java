...
public final class MoveManager {
    ...
    private static boolean wouldKingPassThroughCheck(BitBoard bitBoard, long kingPath, PieceColourType kingColor) {
        long remainingPath = kingPath;
        while (remainingPath != 0) {
            long squareBit = remainingPath & -remainingPath;
            remainingPath &= ~squareBit;
